using ExInterface.Entidades;
using ExInterface.Entidades.Servicos;
using System;
...
namespace ExInterface
{
    class Program
    {
        ...
        
        {
            ...
            ContratoServico _contratoServico = new ContratoServico(new ServicoPaypal());

            _contratoServico.ProcessarContrato(contrato, numeroparcelas);
